...
- 六维数据完整性：权益、仓位、已实现收益、资金费、手续费、资金流分别展示状态
...
- 同步任务保留 30 天、高频权益快照保留 90 天；仅在日汇总存在后清理明细
...
公开只读限制、账务流水归一化与联合查询、六维完整性、Demo 查询、仓位筛选、CSV、
Polymarket 幂等清理、安全数据保留、对账与风险公式。前端覆盖总览、当前仓位、
